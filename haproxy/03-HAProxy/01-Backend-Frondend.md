...
![BackFront](https://github.com/UnstopableSafar08/DevOps/blob/main/haproxy/pictures/03-HAProxy/01-BackFront.jpg)


```bash
mkdir django && cd django
git clone https://github.com/UnstopableSafar08/My_app.git && cd My_app/
...
* HAproxy config file 
```bash
My git [Mygithut](https://github.com/UnstopableSafar08/HAProxy.git) && cd HAProxy
